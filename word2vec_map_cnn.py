...
class Word2VecMapCNN(object):
    '''
    A CNN for word2vec vectors mapping task
    Uses and embedding layer, followed by a convolutional, max-pooling and euclidean layer.
    '''
    def __init__(
		...
		self.scores = tf.nn.xw_plus_b(self.h_drop, W, b, name = "scores")
                self.predictions = tf.tanh(self.scores, name = "predictions")
